...
{
    private ArbolBinarioString arbolBinario;
     ...
     * dibujar.
     */
    public ArbolExpresionGrafico(ArbolBinarioString miArbol) 
    {
   ...
   public void paint(Graphics g) 
   {
    ...
    @Override
    public void onArbolChanged(ArbolBinarioString aBinarioEntero) {
        calcularPosiciones();
    }
